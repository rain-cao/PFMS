<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BM_FactoryManagement.aspx.cs" Inherits="PFMS_S.BackstageManagement.BM_FactoryManagement" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <script type="text/javascript">
        window.onload = function () {
            ...
            if (item == 2) {
                htmlStr = "<button id=\"btnAdd\" type=\"button\" title=\"新增\" class=\"layui-btn layui-btn-sm\" onclick=\"AddFactory()\"><i class=\"layui-icon\">+</i></button>";
        ...
        function GetFactory() {
            ...
            layui.use(['table','layer','form'], function () {
                ...
                table.render({
                    elem: '#FactoryList',
                    url: 'BM_GetFactoryList.ashx?condition=' + condition,
                    title: '厂区清单',
                    cols: [[
                        { field: 'id', title: 'ID', width: 80, unresize: true, sort: true, align: 'center' },
                        { field: 'factory_code', title: '厂区代码',width:250, sort: true, align: 'center' },
                        { field: 'factory_describe', title: '厂区描述', align: 'center' },
...
<body style="font-family:'Microsoft YaHei';">
    ...
    <div style="width:100%;text-align:center;margin:20px auto;">
        <h2 style="color:#666666;">厂区清单</h2>
    </div>
    <div id="div_Table" style="width:99%;margin:0 auto;">
        <div id="btnAddArea" style="text-align:right;width:100%;"></div>
        <table id="FactoryList" class="layui-hide" style="width:100%;" lay-filter="FactoryList"></table>
    </div>
</body>
</html>
