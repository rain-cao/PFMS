<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BM_AddEditUser.aspx.cs" Inherits="PFMS_S.BM_AddEditUser" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <script type="text/javascript">
        ...
        layui.use(['form', 'layer'], function () {
            ...
            //Form提交事件，将注册信息写入数据库
            form.on('submit(AddEditUser)', function (data) {
                ...
                $.ajax({
                    ...
                    success: function (returndata) {
                        if (returndata == 'OK') {
                            layer.alert('用户编辑成功!', { icon: 6 });
                            if (data.field['input_id'] == '0')
                                $('#reset').click();
                        } else {
                            layer.alert('用户编辑失败,Message：' + returndata, { icon: 5 });
                        }
                    },
                    error: function () {
                        layer.alert('用户编辑失败,请确认数据库连接!', { icon: 5 });
                    }
                });
                return false;
            });
...
<body style="font-family:'Microsoft YaHei';">
    <form class="layui-form">
        <h2 runat="server" id="h2Show">用户编辑</h2>
        <br />
        <table>
            <tr>
                ...
                <td style="height: 50px;width: 70%; text-align: left;">
                    <div class="layui-inline" style="width: 80%; text-align: left;">
                        ...
                        <input runat="server" name="name" id="name" type="text" placeholder="中文姓名" autocomplete="off" class="layui-input" style="width: 100%;" lay-verify="name" required="required" />
                    </div>
            ...
            <tr>
                ...
                <td style="height: 50px;text-align: left;">
                    <div class="layui-inline" style="width: 80%; text-align: left;">
                        <input runat="server" name="username" id="username" type="text" placeholder="用户名/用户账号" autocomplete="off" class="layui-input" style="width: 100%;" lay-verify="username" required="required" />
                    </div>
                    <div class="layui-inline">
            ...
            <tr>
                ...
                <td style="height: 50px;text-align: left;">
                    <div class="layui-inline" style="width: 80%; text-align: left;">
                        <input runat="server" name="opid" id="opid" type="text" placeholder="请输入工号" autocomplete="off" class="layui-input" style="width: 100%;text-transform:uppercase;" lay-verify="opid" required="required" />
                    </div>
                    <div class="layui-inline">
            ...
            <tr>
                ...
                <td style="height: 50px;text-align: left;">
                    <div class="layui-inline" style="width: 80%; text-align: left;">
                        <input runat="server" name="password" id="password" type="text" placeholder="请输入登录密码" autocomplete="off" class="layui-input" style="width: 100%;" lay-verify="password" required="required" />
                    </div>
                    <div class="layui-inline">
            ...
            <tr>
                ...
                <td style="height: 50px;text-align: left;">              
                    <div class="layui-inline" style="width: 80%; text-align: left;">
                        <input runat="server" name="rpassword" id="rpassword" type="text" placeholder="再次输入登录密码" autocomplete="off" class="layui-input" style="width: 100%;" />
                    </div>
                    <div class="layui-inline">
            ...
            <tr>
                ...
                <td style="height: 50px;text-align: left;">              
                    <div class="layui-inline" style="width: 80%; text-align: left;">
                        <input runat="server" name="telephone" id="telephone" type="text" placeholder="用户手机号码" autocomplete="off" class="layui-input" style="width: 100%;" />
                    </div>
                </td>
            </tr>
            <tr>
                ...
                <td style="height: 50px;text-align: left;">              
                    <div class="layui-inline" style="width: 80%; text-align: left;">
                        <input runat="server" name="email" id="email" type="text" placeholder="someone@Example.com.cn" autocomplete="off" class="layui-input" style="width: 100%;" lay-verify="email" required="required" />
                    </div>
                    <div class="layui-inline">
            ...
            <tr>
                ...
                <td style="height: 50px;text-align: left;">              
                    <div class="layui-inline" style="width: 80%; text-align: left;">
                        <input runat="server" name="weixin_no" id="weixin_no" type="text" placeholder="用户微信号" autocomplete="off" class="layui-input" style="width: 100%;" />
                    </div>
                </td>
            </tr>
            <tr>
                <td colspan="2" style="text-align:center;">
                    <hr />
                    <button runat="server" id="btnAddEdit" type="submit" lay-submit="" lay-filter="AddEditUser" class="layui-btn layui-btn-lg">添加</button>
