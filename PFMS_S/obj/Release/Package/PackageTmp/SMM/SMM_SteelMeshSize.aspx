<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SMM_SteelMeshSize.aspx.cs" Inherits="PFMS_S.SteelMeshManagement.SMM_SteelMeshSize" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <script type="text/javascript">
        window.onload = function () {
            ...
            var htmlStr = "";
            if (item == 2) {
                htmlStr = "<button id=\"btnAdd\" type=\"button\" title=\"新增\" class=\"layui-btn layui-btn-sm\" onclick=\"AddSize()\"><i class=\"layui-icon\">+</i></button>";
        ...
        function GetSize() {
            ...
            layui.use(['table', 'layer','form'], function () {
                ...
                table.render({
                    elem: '#SizeList',
                    url: 'SMM_GetSizeList.ashx?condition=' + condition,
                    title: '厂区清单',
                    cols: [[
                        { field: 'id', title: 'ID', width: 80, unresize: true, sort: true, align: 'center' },
                        { field: 'size', title: '钢网尺寸', align: 'center' },
                ...
                //监听行工具事件,用来删除记录
                table.on('tool(SizeList)', function (obj) {
                    var data = obj.data;
                    //console.log(obj)
                    if (obj.event === 'del') {
                        layer.confirm('真的删除行么', function (index) {
                            $.ajax({
                                url: 'SMM_DelSize.ashx',
                                data: { 'id': obj.data.id },
                                dataType: 'text',
...
<body style="font-family:'Microsoft YaHei';">
    ...
    <div style="width:100%;text-align:center;margin:20px auto;">
        <h2 style="color:#666666;">钢网尺寸清单</h2>
    </div>
    <div id="div_Table" style="width:99%;margin:0 auto;">
        <div id="btnAddArea" style="text-align:right;width:100%;"></div>
        <table id="SizeList" class="layui-hide" style="width:100%;" lay-filter="SizeList"></table>
    </div>
</body>
</html>
