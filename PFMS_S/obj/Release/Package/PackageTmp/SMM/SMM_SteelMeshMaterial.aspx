<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SMM_SteelMeshMaterial.aspx.cs" Inherits="PFMS_S.SteelMeshManagement.SMM_SteelMeshMaterial" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <script type="text/javascript">
        window.onload = function () {
            ...
            var htmlStr = "";
            if (item == 2) {
                htmlStr = "<button id=\"btnAdd\" type=\"button\" title=\"新增\" class=\"layui-btn layui-btn-sm\" onclick=\"AddMaterial()\"><i class=\"layui-icon\">+</i></button>";
        ...
        function GetMaterial() {
            ...
            layui.use(['table', 'layer','form'], function () {
                ...
                table.render({
                    elem: '#MaterialList',
                    url: 'SMM_GetMaterialList.ashx?condition=' + condition,
                    title: '厂区清单',
                    cols: [[
                        { field: 'id', title: 'ID', width: 80, unresize: true, sort: true, align: 'center' },
                        { field: 'Material', title: '钢网材料', align: 'center' },
...
<body style="font-family:'Microsoft YaHei';">
    ...
    <div style="width:100%;text-align:center;margin:20px auto;">
        <h2 style="color:#666666;">钢网材料清单</h2>
    </div>
    <div id="div_Table" style="width:99%;margin:0 auto;">
        <div id="btnAddArea" style="text-align:right;width:100%;"></div>
        <table id="MaterialList" class="layui-hide" style="width:100%;" lay-filter="MaterialList"></table>
    </div>
</body>
</html>
