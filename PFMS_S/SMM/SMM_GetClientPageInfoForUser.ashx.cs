...
{
    /// <summary>
    /// SMM_GetClientPageInfoForUser 的摘要说明
    /// </summary>
    public class SMM_GetClientPageInfoForUser : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            try
            {
                ...
                mycom.CommandText = "select id,client_page from SteelMesh_ClientPage";
                ...
                dr.Close();
                dr = null;
                mycom.CommandText = "select clintpage_id from SteelMesh_ClientPagePower where user_id='" + user_id + "'";
