...
{
    /// <summary>
    /// SMM_EditInfoRequired 的摘要说明
    /// </summary>
    public class SMM_EditInfoRequired : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            try
            {
                ...
                sb.Clear();
                sb.Append("update SteelMesh_Info_List set required=\n");
                sb.Append("case (select required from SteelMesh_Info_List where id='" + idStr + "')\n");
