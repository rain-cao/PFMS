...
{
    /// <summary>
    /// SMM_GetMaterialList 的摘要说明
    /// </summary>
    public class SMM_GetMaterialList : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            try
            {
                ...
                sb.Clear();
                sb.Append("SELECT\n");
                sb.Append("id,Material\n");
                sb.Append("FROM\n");
                sb.Append("SteelMeshMaterial\n");
                if (condition != "")
                    sb.Append("WHERE Material LIKE '%" + condition + "%'\n");
