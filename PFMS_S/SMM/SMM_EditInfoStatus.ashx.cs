...
{
    /// <summary>
    /// SMM_EditInfoStatus 的摘要说明
    /// </summary>
    public class SMM_EditInfoStatus : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            try
            {
                ...
                sb.Clear();
                sb.Append("update SteelMesh_Info_List set status=\n");
                sb.Append("case (select status from SteelMesh_Info_List where id='" + idStr + "')\n");
