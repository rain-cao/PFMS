<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SMM_CleanType.aspx.cs" Inherits="PFMS_S.SMM.SMM_CleanType" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <script type="text/javascript">
        window.onload = function () {
            ...
            var htmlStr = "";
            if (item == 2) {
                htmlStr = "<button id=\"btnAdd\" type=\"button\" title=\"新增\" class=\"layui-btn layui-btn-sm\" onclick=\"AddClean()\"><i class=\"layui-icon\">+</i></button>";
        ...
        function GetClean() {
            ...
            layui.use(['table', 'layer','form'], function () {
                ...
                table.render({
                    elem: '#CleanList',
                    url: 'SMM_GetCleanList.ashx?condition=' + condition,
                    title: '钢网清洗类型',
                    cols: [[
                        { field: 'id', title: 'ID', width: 80, unresize: true, sort: true, align: 'center' },
                        { field: 'clean_type', title: '钢网清洗类型', align: 'center' },
...
<body style="font-family:'Microsoft YaHei';">
    ...
    <div style="width:100%;text-align:center;margin:20px auto;">
        <h2 style="color:#666666;">钢网清洗方式</h2>
    </div>
    <div id="div_Table" style="width:99%;margin:0 auto;">
        <div id="btnAddArea" style="text-align:right;width:100%;"></div>
        <table id="CleanList" class="layui-hide" style="width:100%;" lay-filter="CleanList"></table>
    </div>
</body>
</html>
